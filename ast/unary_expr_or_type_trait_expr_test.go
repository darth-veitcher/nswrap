...
func TestUnaryExprOrTypeTraitExpr(t *testing.T) {
	nodes := map[string]testNode{
		...
		testNode{&UnaryExprOrTypeTraitExpr{
			Addr:       0x7fccd70adf50,
		...
		`0x7fae1a800190 <col:36, col:44> 'unsigned long' sizeof`:
		testNode{&UnaryExprOrTypeTraitExpr{
			Addr:       0x7fae1a800190,
		...
		`0x557e575e70b8 <col:432, col:452> 'unsigned long' sizeof 'union MyUnion':'union MyUnion'`:
		testNode{&UnaryExprOrTypeTraitExpr{
			Addr:       0x557e575e70b8,
		...
		`0x3f142d8 <col:30, col:45> 'unsigned long' sizeof 'extCoord':'extCoord'`:
		testNode{&UnaryExprOrTypeTraitExpr{
			Addr:       0x3f142d8,
